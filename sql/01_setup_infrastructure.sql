...
-- ============================================================
-- 2. SCHEMAS
-- BRONZE schemas (ERP, CRM, MARKETING) are created automatically by Fivetran
-- Pre-create admin and governance schemas only
-- ============================================================
...
CREATE SCHEMA IF NOT EXISTS SILVER.ERP;
CREATE SCHEMA IF NOT EXISTS SILVER.CRM;
...
-- ============================================================
CREATE RESOURCE MONITOR IF NOT EXISTS MYNTRA_CLV_MONITOR WITH
    CREDIT_QUOTA = 100
    FREQUENCY = MONTHLY
    START_TIMESTAMP = IMMEDIATELY
    NOTIFY_USERS = ('{{PLACEHOLDER_ADMIN_EMAIL}}')
    TRIGGERS
        ON 75  PERCENT DO NOTIFY
        ON 90  PERCENT DO NOTIFY
        ON 100 PERCENT DO NOTIFY;

ALTER WAREHOUSE LOADING_WH   SET RESOURCE_MONITOR = MYNTRA_CLV_MONITOR;
ALTER WAREHOUSE TRANSFORM_WH SET RESOURCE_MONITOR = MYNTRA_CLV_MONITOR;